...
Java_com_gongkao_cuotifupan_ocr_paddle_OCRPredictorNative_init(
...
Java_com_gongkao_cuotifupan_ocr_paddle_OCRPredictorNative_forward(
...
Java_com_gongkao_cuotifupan_ocr_paddle_OCRPredictorNative_release(
